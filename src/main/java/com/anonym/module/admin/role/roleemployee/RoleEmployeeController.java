...
public class RoleEmployeeController {
    ...
    @PostMapping("/admin/role/listEmployee")
    ...
    @GetMapping("/admin/role/listAllEmployee/{roleId}")
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "employeeId", value = "员工id", paramType = "query", required = true), @ApiImplicitParam(name = "roleId", value = "角色id", paramType = "query",
            required = true)})
    @GetMapping("/admin/role/removeEmployee")
    ...
    @PostMapping("/admin/role/removeEmployeeList")
    ...
    @PostMapping("/admin/role/addEmployeeList")
    ...
    @GetMapping("/admin/role/getRoles/{employeeId}")
