...
public class EmployeeResponseCodeConst extends ResponseCodeConst {
    ...
    public static final EmployeeResponseCodeConst VERIFICATION_CODE_INVALID = new EmployeeResponseCodeConst(3011, "验证码不正确");

    public static final EmployeeResponseCodeConst LOGIN_ERROR = new EmployeeResponseCodeConst(3012, "您还未登录或登录失效，请重新登录！");

    public static final EmployeeResponseCodeConst NOT_HAVE_PRIVILEGES = new EmployeeResponseCodeConst(3013, "对不起，您没有权限哦！");

    public static final EmployeeResponseCodeConst NOT_ALLOW_ENABLE_STOP = new EmployeeResponseCodeConst(3014, "该账户有关联商家,无法禁用");


    /**
     * 不用需删除
     */
    public static final EmployeeResponseCodeConst NOT_ALLOW_DELETE = new EmployeeResponseCodeConst(3015, "非禁用状态，不允许删除");
