...
import com.anonym.module.admin.employee.basic.domain.dto.EmployeeQueryExportDTO;
...
public interface EmployeeDao extends BaseMapper<EmployeeEntity> {
     ...
     * 根据员工ID集合查询员工列表
     */
    List<EmployeeEntity> selectByEmployeeIds(@Param("list") List<Long> employeeIds);
