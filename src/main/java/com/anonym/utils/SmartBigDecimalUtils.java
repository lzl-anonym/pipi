...
public class SmartBigDecimalUtils {
    ...
    public static void main(String[] args) {
        List<BigDecimal> integers = Arrays.asList(BigDecimal.valueOf(1), BigDecimal.valueOf(1), BigDecimal.valueOf(3));
        BigDecimal bigDecimal = add(integers, BigDecimal :: plus);
