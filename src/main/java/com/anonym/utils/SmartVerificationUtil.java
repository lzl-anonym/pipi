...
public class SmartVerificationUtil {
     ...
     * 手机号码验证规则
     */
    public static final String PHONE_REGEXP = "^1(3|4|5|6|7|8|9)\\d{9}$";

    public static void main(String[] args) {
        boolean matches = Pattern.matches(SmartVerificationUtil.LICENSE_18, "上");
     ...
     * 身份证 正则校验
     */
    public static final String IDENTITY_CARD = "(^[1-8][0-7]{2}\\d{3}([12]\\d{3})(0[1-9]|1[012])(0[1-9]|[12]\\d|3[01])\\d{3}([0-9Xx])$)";
