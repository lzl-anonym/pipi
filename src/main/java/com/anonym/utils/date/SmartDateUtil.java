...
public class SmartDateUtil extends DateUtils {
    ...
    public static String formatHMSMillisecond(Date date) {
        return dateFormats.get().hmsSSS.format(date);
    }
...
class DateFormats {
    ...
    public final SimpleDateFormat hmsSSS = new SimpleDateFormat("HHmmssSSS");
