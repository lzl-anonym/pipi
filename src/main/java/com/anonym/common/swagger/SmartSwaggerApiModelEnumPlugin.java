...
package com.anonym.common.swagger;
...
public class SmartSwaggerApiModelEnumPlugin implements ModelPropertyBuilderPlugin {
    ...
    public void apply(ModelPropertyContext context) {
        ...
        if (annotation.isPresent()) {
            ...
            context.getBuilder().required(annotation.transform(toIsRequired()).or(false)).description(enumDesc + ":" + enumInfo).example(annotation.transform(toExample()).orNull());
        }
    }
